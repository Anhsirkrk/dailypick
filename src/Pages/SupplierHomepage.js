    ...
    <div className='supplier-page'>
      <div className='supplierpage-left-side'>
        <div className='Supplier-Options-list'>
          ...
          <div className={`Supplier-Options ${selectedOption === 'SupplierOrderHistory' ? 'Supplier-Optionsselected' : ''}`} onClick={() =>{handleOptionClick('SupplieSupplierOrderHistoryrTodayList'); setContentType('SupplierOrderHistory')}}>History</div>
