...
const Home = () => {
  ...
  <div className="frame-19">
    <div className="frame-20">
      <div className="best-sellers">Daily Needs</div>
    ...
    <div className="frame-21">
      <div className="best-sellers">Brands</div>
      <div className="group-22252">
        <div className="rectangle-1429">
          <img className="rectangle-1428" src="rectangle-1428.png" />
        </div>
        <div className="rectangle-1430">
          <img className="rectangle-1428" src="rectangle-1428.png" />
        </div>
        <div className="rectangle-1431">
          <img className="rectangle-1428" src="rectangle-1428.png" />
        </div>
        <div className="rectangle-1432">
          <img className="rectangle-1428" src="rectangle-1428.png" />
        </div>
      </div>
    </div>
  </div>
  <div className="rectangle-14103"></div>
  <div className="logo">logo</div>
  <div className="component-15">
    <svg
      className="material-symbols-location-on-outline"
      width="25"
      height="25"
      viewBox="0 0 25 25"
      fill="none"
  ...
  <div className="frame-29">
    <div className="frame-24">
      <div className="milk">News-Paper</div>
    </div>
    <div className="frame-22">
      <div className="milk">Milk</div>
    </div>
    <div className="frame-23">
      <div className="milk">Curd</div>
    </div>
    <div className="frame-28">
      <div className="milk">Eggs</div>
    </div>
    <div className="frame-26">
      <div className="milk">Vegetables</div>
    </div>
    <div className="frame-25">
      <div className="milk">Breads</div>
    </div>
    <div className="frame-27">
      <div className="milk">Cookies</div>
    </div>
  </div>
</div>
